...
<?php
  ...
  //Se não estiver logged in, ou se estiver e for Voluntario vai para a pagina inicial
...
<form action="disponibilidade_parceiro.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin">
    <h2 class="w3-center">Disponibilidade de doação: </h2>
    <p>Selecione os dias da semana e os respetivos horários de recolha: </p>
    ...
    <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-calendar"></i></div>
        ...
        <button class="w3-button w3-block w3-section w3-blue w3-ripple w3-padding" href="home_parceiro.html">Registar</button>
</form>
</body>
